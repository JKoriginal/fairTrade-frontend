...
import { Truck, Package, Users, ShoppingBag, Trash2 } from "lucide-react";
    ...
    const fetchStats = async () => {
      try {
        ...
        const deliveryRes = await fetch(
          "http://localhost:5000/api/deliveries/count"
        );
        ...
        setStats((prevStats) =>
          prevStats.map((stat) =>
            stat.name === "Total Users"
              ? { ...stat, value: (Number(stat.value) - 1).toString() }
              : stat
          )
        );
